...
class FollowerStopper(BaseController):
    ...
    def __init__(self,
        ...
        self.max_decel = car_following_params.controller_params['decel']
    ...
    def get_accel(self, env):
        ...
        lead_vel = env.k.vehicle.get_speed(self.leader_id)
        ...
        if self.find_intersection_dist(env) <= 10 and \
            ...
            return min(accel, self.max_accel) if accel >=0 else max(accel, -self.max_decel)
