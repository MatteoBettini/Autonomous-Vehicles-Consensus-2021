...
def parse_args(args):
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="python run_exp_local.py EXP_CONFIG --num_runs INT --no_render")

    # required input parameters
    parser.add_argument(
        '--exp_config', type=str, default='ring_local_config',
...
if __name__ == "__main__":
    ...
    module = __import__("exp_configs.local", fromlist=[flags.exp_config])
    ...
    exp.run(flags.num_runs, convert_to_csv=not flags.no_gen_emission)